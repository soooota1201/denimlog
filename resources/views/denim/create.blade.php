...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <form method="POST" action="{{route('denims.store')}}" class="mt5">
              @csrf
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="30" name="waist">
              </div>
              <div class="form-group">
                <label for="">履き込み回数（任意、新品は空欄）</label>
                <input type="text" class="form-control" placeholder="30" name="wearing_count">
              </div>
